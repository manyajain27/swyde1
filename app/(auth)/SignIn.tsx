      ...
      >
        ...
        >
          ...
          <View style={[styles.welcomeContainer, Platform.OS === 'android' && styles.welcomeContainerAndroid]}>
            <Text style={[styles.welcomeText, Platform.OS === 'android' && styles.welcomeTextAndroid]}>Hey,</Text>
            <Text style={[styles.welcomeText, Platform.OS === 'android' && styles.welcomeTextAndroid]}>
              Welcome to <Text style={styles.brandText}>Swyde</Text>
            </Text>
          </View>
